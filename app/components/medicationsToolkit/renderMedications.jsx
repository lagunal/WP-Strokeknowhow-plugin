        ...
        rows.push(
            <div className='row' style={{backgroundColor: bc}}>
                <div className='col-4 align-self-center' >   
                    <input type='text' className='form-control' name={'medicine' + i} 
                           value={props.myDataProp['medicine' + i]} onChange={props.updateStateProp} />
                </div>
                <div className='col p-2 m-1' >   
                    <input type='text' className='form-control' name={'time' + i} 
                           value={props.myDataProp['time' + i]} onChange={props.updateStateProp} />
                </div>
