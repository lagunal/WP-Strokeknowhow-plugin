 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Custom Toolkit
 * Plugin URI:        https://gopangolin.com
 * Description:       Custom Toolkit plugin for Stroke Know How
 * Version:           1.0.0
 * Author:            pangolin
...
/**
 * TO-DO:
 * - when first time toolkit bring data from json
 * 
 * 
 *
 *  
...
function init() {
	...
	$wpr_rest = Endpoint\Shortcode::get_instance();
}
